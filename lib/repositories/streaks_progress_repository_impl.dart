...
final class StreaksProgressRepositoryImpl implements StreaksProgressRepository {
  static const _streaksCollection = 'streaks';

  const StreaksProgressRepositoryImpl();
  ...
  DocumentReference<Map<String, dynamic>> _streaksProgressDoc(String userId) =>
      FirebaseFirestore.instance.collection(_streaksCollection).doc(userId);
